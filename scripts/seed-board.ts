...
const COMPETITOR_CHANNELS = [
  ...
  { name: "Aperture", channelId: "UCO5QSoES5yn2Dw7YixDYT5Q", tier: "tier1" as const },
  { name: "Kraut", channelId: "UCr_Q-bPpcw5fJ-Oow1BW1NQ", tier: "tier1" as const },
  { name: "Second Thought", channelId: "UCJm2TgUqtK1_NLBrjNQ1P-w", tier: "tier1" as const },
  { name: "Ryan Chapman", channelId: "UC6FO-Up1-oLj5nNivCNHL-Q", tier: "tier1" as const },
  { name: "What I've Learned", channelId: "UCqYPhGiB9tkShZorfgcL2lA", tier: "tier1" as const },
  { name: "Ryan Pictures", channelId: "UCXg2L_c6fFI-hH3lzsGOQkg", tier: "tier1" as const },
  { name: "captainmidnight", channelId: "UCROQqK3_z79JuTetNP3pIXQ", tier: "tier1" as const },
  // Tier 2
  ...
  { name: "Pursuit of Wonder", channelId: "UC-tLyAaPbRZiYrOJxAGB7dQ", tier: "tier2" as const },
  { name: "Whatifalthist", channelId: "UC5Dw9TFdbPJoTDMSiJdIQTA", tier: "tier2" as const },
  { name: "Tom Nicholas", channelId: "UCxt2r57cLastdmrReiQJkEg", tier: "tier2" as const },
  { name: "Nick Crowley", channelId: "UCMX31RavkfUHJvw03RbUZnA", tier: "tier2" as const },
  { name: "Bright Sun Films", channelId: "UC5k3Kc0avyDJ2nG9Kxm9JmQ", tier: "tier2" as const },
  { name: "Coffeehouse Crime", channelId: "UCcUf33cEPky2GiWBgOP-jQA", tier: "tier2" as const },
  { name: "JCS - Criminal Psychology", channelId: "UCYwVxWpjeKFWwu8TML-Te9A", tier: "tier2" as const },
  { name: "Slidebean", channelId: "UC4bq21IPPbpu0Qrsl7LW0sw", tier: "tier2" as const },
  { name: "Knowing Better", channelId: "UC8XjmAEDVZSCQjI150cb4QA", tier: "tier2" as const },
  { name: "Solar Sands", channelId: "UCR6LasBpceuYUhuLToKBzvQ", tier: "tier2" as const },
  { name: "Boy Boy", channelId: "UC_S45UpAYVuc0fYEcHN9BVQ", tier: "tier2" as const },
  { name: "Oki's Weird Stories", channelId: "UCjDQKxiTVpXutZc2Ra9wCAg", tier: "tier2" as const },
  { name: "Jack Saint", channelId: "UCdQKvqmHKe_8fv4Rwe7ag9Q", tier: "tier2" as const },
  { name: "Wendover Productions", channelId: "UC9RM-iSvTu1uPJb8X5yp3EQ", tier: "tier2" as const },
  { name: "Cash Jordan", channelId: "UCrwbBzP11NhxRUCRKx_BgoQ", tier: "tier2" as const },
  { name: "Fireship", channelId: "UCsBjURrPoezykLs9EqgamOA", tier: "tier2" as const },
  { name: "Phat Memer", channelId: "UCwPy85bZrLGYDRU3AOSK8Ow", tier: "tier2" as const },
  { name: "TrappUniversity", channelId: "UCJJ1DrDsAW1emEwDwFJjRCA", tier: "tier2" as const },
  { name: "Coolea", channelId: "UCj5l6GNdcpnT2sEsJjBfz7w", tier: "tier2" as const },
  { name: "TheGamerFromMars", channelId: "UCJ6z_yj_dDNrhn-c8ZyKV4g", tier: "tier2" as const },
  { name: "decoy", channelId: "UCqN2iOW580CFSohYzruos2A", tier: "tier2" as const },
  { name: "Nerdstalgic", channelId: "UCXjmz8dFzRJZrZY8eFiXNUQ", tier: "tier2" as const },
  { name: "Lessons in Meme Culture", channelId: "UCaHT88aobpcvRFEuy4v5Clg", tier: "tier2" as const },
  { name: "Cole Hastings", channelId: "UCwQnoax3HWID1WOzZ4mqLPQ", tier: "tier2" as const },
  { name: "American Redact", channelId: "UCsLGW4mXzWqvtityp1T6CKQ", tier: "tier2" as const },
  { name: "JAMARI", channelId: "UCr0XW6TU9XVWlWPpEwEyf3g", tier: "tier2" as const },
];
